  ...
  return (
    <div className="container" style={{ maxWidth: 760 }}>
      <div className="panel stack legal-doc">
        <h1 style={{ fontSize: 'var(--fs-xl)' }}>Gizlilik Politikası</h1>
        ...
        <h2 style={{ fontSize: 'var(--fs-md)' }}>Veri sorumlusu</h2>
        <p>Eren Süner, iletişim: erenn.suner@gmail.com.</p>

        <h2 style={{ fontSize: 'var(--fs-md)' }}>İşlenen veriler</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 'var(--fs-md)' }}>İşleme amaçları ve hukuki sebep</h2>
        <p>
        ...
        <h2 style={{ fontSize: 'var(--fs-md)' }}>Aktarım ve barındırma</h2>
        <p>
        ...
        <h2 style={{ fontSize: 'var(--fs-md)' }}>Saklama süresi</h2>
